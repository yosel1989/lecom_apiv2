...
<div class="container mt-5">
    ...
    <div class="w-100 text-center">
        ...
        <img src="data:image/png;base64, {{ $qrcode }}" alt="" width="120" height="120" style="display:block; margin:0;width:120px; height: 120px" >
