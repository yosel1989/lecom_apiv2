...
Route::namespace('Api\TransportePersonal\Paradero')->middleware('auth:api')->group( function (){
...
Route::namespace('Api\TransportePersonal\TipoRuta')->middleware('auth:api')->group( function (){
...
Route::namespace('Api\TransportePersonal\Ruta')->middleware('auth:api')->group( function (){
...
Route::namespace('Api\TransportePersonal\Reporte')->middleware('auth:api')->group( function (){
    Route::get('transporte-personal/reporte/cliente/{id}/{fechaDesde}/{fechaHasta}', 'GetReporteByClientController');
});



Route::namespace('Api\TransportePersonal\Ruta')->group( function (){
...
Route::namespace('Api\TransportePersonal\TipoRuta')->group( function (){
...
Route::namespace('Api\TransportePersonal\AbordajeDestino')->group( function (){
    Route::post('app/transporte-personal/abordaje-destino', 'CreateController');
});
Route::namespace('Api\TransportePersonal\ParaderoHora')->group( function (){
