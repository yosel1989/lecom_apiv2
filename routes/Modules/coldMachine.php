...
Route::namespace('App\Http\Controllers\Api\Cold\ColdMachineModel')->middleware('auth:api')->group( function (){
...
//Route::namespace('Api\Cold\ColdMachineModel')->middleware('auth:api')->group( function (){
Route::namespace('App\Http\Controllers\Api\Cold\ColdMachine')->middleware('auth:api')->group( function (){
...
//Route::namespace('Api\Cold\ColdMachineModel')->middleware('auth:api')->group( function (){
Route::namespace('App\Http\Controllers\Api\Cold\ColdMachineAlert')->middleware('auth:api')->group( function (){
...
//Route::namespace('Api\Cold\ColdMachineModel')->middleware('auth:api')->group( function (){
Route::namespace('App\Http\Controllers\Api\Cold\ColdMachineAlertHistory')->middleware('auth:api')->group( function (){
...
//Route::namespace('Api\Cold\ColdMachineModel')->middleware('auth:api')->group( function (){
Route::namespace('App\Http\Controllers\Api\Cold\ColdMachineRealTime')->middleware('auth:api')->group( function (){
