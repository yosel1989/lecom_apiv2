...
class GetListModelAController extends Controller
{
    private \Src\V2\CronogramaSalida\Infrastructure\GetListModelAController $controller;

    public function __construct(\Src\V2\CronogramaSalida\Infrastructure\GetListModelAController $controller)
    {
