...
{
    private \Src\V2\CronogramaSalida\Infrastructure\GetReporteDespachoByClienteController $controller;

    public function __construct(\Src\V2\CronogramaSalida\Infrastructure\GetReporteDespachoByClienteController $controller)
    {
