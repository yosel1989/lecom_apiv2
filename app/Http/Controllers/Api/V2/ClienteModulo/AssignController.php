...
{
    private \Src\V2\ClienteModulo\Infrastructure\AssignController $controller;

    public function __construct(\Src\V2\ClienteModulo\Infrastructure\AssignController $controller)
    {
