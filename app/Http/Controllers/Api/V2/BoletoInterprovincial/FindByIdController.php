...
class FindByIdController extends Controller
{
    ...
    public function __construct(\Src\V2\BoletoInterprovincial\Infrastructure\FindByIdController $controller)
    {
    ...
    public function __invoke(Request $request)
    {
        try {
            ...
            $vehicle = BoletoInterprovincialResource::make($this->controller->__invoke($request));
