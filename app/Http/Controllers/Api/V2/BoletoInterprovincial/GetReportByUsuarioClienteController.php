...
class GetReportByUsuarioClienteController extends Controller
{
    private \Src\V2\BoletoInterprovincial\Infrastructure\GetReportByUsuarioClienteController $controller;

    public function __construct(\Src\V2\BoletoInterprovincial\Infrastructure\GetReportByUsuarioClienteController $controller)
    {
