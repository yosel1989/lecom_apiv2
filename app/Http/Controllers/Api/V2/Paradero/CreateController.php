...
{
    private \Src\V2\Paradero\Infrastructure\CreateController $controller;

    public function __construct(\Src\V2\Paradero\Infrastructure\CreateController $controller)
    {
