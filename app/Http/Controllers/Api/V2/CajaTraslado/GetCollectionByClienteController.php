...
{
    private \Src\V2\Egreso\Infrastructure\GetCollectionByClienteController $controller;

    public function __construct(\Src\V2\Egreso\Infrastructure\GetCollectionByClienteController $controller)
    {
