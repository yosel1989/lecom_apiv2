...
{
    private \Src\V2\ComprobanteSerie\Infrastructure\CreateController $controller;

    public function __construct(\Src\V2\ComprobanteSerie\Infrastructure\CreateController $controller)
    {
