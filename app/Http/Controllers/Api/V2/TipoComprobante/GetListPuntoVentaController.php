...
class GetListPuntoVentaController extends Controller
{
    private \Src\V2\TipoComprobante\Infrastructure\GetListPuntoVentaController $controller;

    public function __construct(\Src\V2\TipoComprobante\Infrastructure\GetListPuntoVentaController $controller)
    {
