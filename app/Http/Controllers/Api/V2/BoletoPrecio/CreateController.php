...
{
    private \Src\V2\BoletoPrecio\Infrastructure\CreateController $controller;

    public function __construct(\Src\V2\BoletoPrecio\Infrastructure\CreateController $controller)
    {
