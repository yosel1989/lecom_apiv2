...
{
    private \Src\V2\Liquidacion\Infrastructure\GetCollectionByClienteController $controller;

    public function __construct(\Src\V2\Liquidacion\Infrastructure\GetCollectionByClienteController $controller)
    {
