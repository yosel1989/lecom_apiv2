...
{
    private \Src\V2\Ingreso\Infrastructure\GetReporteByClienteController $controller;

    public function __construct(\Src\V2\Ingreso\Infrastructure\GetReporteByClienteController $controller)
    {
