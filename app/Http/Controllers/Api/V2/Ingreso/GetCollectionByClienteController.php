...
{
    private \Src\V2\Ingreso\Infrastructure\GetCollectionByClienteController $controller;

    public function __construct(\Src\V2\Ingreso\Infrastructure\GetCollectionByClienteController $controller)
    {
