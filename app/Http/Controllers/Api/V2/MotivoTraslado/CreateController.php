...
{
    private \Src\V2\MotivoTraslado\Infrastructure\CreateController $controller;

    public function __construct(\Src\V2\MotivoTraslado\Infrastructure\CreateController $controller)
    {
