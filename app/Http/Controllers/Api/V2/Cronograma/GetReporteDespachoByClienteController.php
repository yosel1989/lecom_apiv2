...
{
    private \Src\V2\Cronograma\Infrastructure\GetReporteDespachoByClienteController $controller;

    public function __construct(\Src\V2\Cronograma\Infrastructure\GetReporteDespachoByClienteController $controller)
    {
