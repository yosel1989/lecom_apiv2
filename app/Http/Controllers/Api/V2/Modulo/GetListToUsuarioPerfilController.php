...
{
    private \Src\V2\Modulo\Infrastructure\GetListToUsuarioPerfilController $controller;

    public function __construct(\Src\V2\Modulo\Infrastructure\GetListToUsuarioPerfilController $controller)
    {
