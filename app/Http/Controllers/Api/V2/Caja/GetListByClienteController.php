...
{
    private \Src\V2\Caja\Infrastructure\GetListByClienteController $controller;

    public function __construct(\Src\V2\Caja\Infrastructure\GetListByClienteController $controller)
    {
