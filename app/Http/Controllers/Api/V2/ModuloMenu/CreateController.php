...
{
    private \Src\V2\ModuloMenu\Infrastructure\CreateController $controller;

    public function __construct(\Src\V2\ModuloMenu\Infrastructure\CreateController $controller)
    {
