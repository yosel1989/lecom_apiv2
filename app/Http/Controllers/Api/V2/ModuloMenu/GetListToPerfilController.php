...
{
    private \Src\V2\ModuloMenu\Infrastructure\GetListToPerfilController $controller;

    public function __construct(\Src\V2\ModuloMenu\Infrastructure\GetListToPerfilController $controller)
    {
