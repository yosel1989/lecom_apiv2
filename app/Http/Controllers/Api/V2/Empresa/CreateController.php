...
{
    private \Src\V2\Empresa\Infrastructure\CreateController $controller;

    public function __construct(\Src\V2\Empresa\Infrastructure\CreateController $controller)
    {
