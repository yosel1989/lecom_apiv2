...
class GetCollectionByClientController extends Controller
{
    ...
    /**
    * @var \Src\Admin\SimCard\Infrastructure\GetCollectionByClientController
     */
    private $controller;

    public function __construct(\Src\Admin\SimCard\Infrastructure\GetCollectionByClientController $controller )
    {
