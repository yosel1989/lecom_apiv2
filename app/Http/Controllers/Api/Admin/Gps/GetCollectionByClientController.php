...
class GetCollectionByClientController extends Controller
{
    ...
    /**
    * @var \Src\Admin\Gps\Infrastructure\GetCollectionByClientController
     */
    private $controller;

    public function __construct(\Src\Admin\Gps\Infrastructure\GetCollectionByClientController $controller )
    {
