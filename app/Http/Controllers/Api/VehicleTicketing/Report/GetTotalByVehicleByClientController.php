...
use DB;
use Src\VehicleTicketing\Report\Infraestructure\TotalByVehicleController;

class GetTotalByVehicleByClientController extends Controller
{
    private $controller;

    public function __construct(TotalByVehicleController $controller )
    {
