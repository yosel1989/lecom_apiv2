...
use DB;
use Src\VehicleTicketing\Report\Infraestructure\TicketsByClientFleetRangeHourController as Recontroller;

class TicketsByClientFleetRangeHourController extends Controller
{
    private $controller;
