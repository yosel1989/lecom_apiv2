...
use DB;
use Src\VehicleTicketing\Report\Infraestructure\TicketsByVehicleRangeHourController as Recontroller;

class TicketsByVehicleRangeHourController extends Controller
{
    private $controller;
