...
use DB;
use Src\VehicleTicketing\Report\Infraestructure\TotalByClientHourController;

class GetTotalByClientHourController extends Controller
{
    private $controller;

    public function __construct(TotalByClientHourController $controller )
    {
