...
{
    /**
     * @var \Src\Administracion\Egreso\Infraestructure\GetReportByClientController
     */
    private $controller;

    public function __construct(\Src\Administracion\Egreso\Infraestructure\GetReportByClientController $controller)
    {
