...
class CreateColdMachineHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cold_machine_history', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('cold_machine_history');
    }
}
