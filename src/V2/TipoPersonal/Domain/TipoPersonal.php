...
final class TipoPersonal
{
    ...
    private ValueBoolean $idEliminado;
     ...
     * @param ValueBoolean $idEliminado
     ...
     * @return ValueBoolean
     */
    public function getIdEliminado(): ValueBoolean
    {
     ...
     * @param ValueBoolean $idEliminado
     */
    public function setIdEliminado(ValueBoolean $idEliminado): void
    {
        $this->idEliminado = $idEliminado;
    }
