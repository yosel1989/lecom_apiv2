...
final class GetReportByClienteGroupVehiculoUseCase
{
    ...
    public function __invoke(string $idCliente, string $fechaDesde, string $fechaHasta, ?string $idRuta, VehiculoShortList $vehiculos): array
    {
        ...
        return $this->repository->reportByClienteGroupVehiculo($_idCliente, $_fechaDesde, $_fechaHasta, $_idRuta, $vehiculos);
    }
}
