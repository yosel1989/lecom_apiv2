...
use Src\VehicleTicketing\Report\Application\TotalTopByFleetUseCase;
use Src\VehicleTicketing\Report\Infraestructure\Repositories\EloquentTicketReportRepository;

final class TotalTopByFleetController
{
    private $repository;
    ...
    public function __invoke( Request $request ): array
    {
        ...
        $useCase = new TotalTopByFleetUseCase($this->repository);
