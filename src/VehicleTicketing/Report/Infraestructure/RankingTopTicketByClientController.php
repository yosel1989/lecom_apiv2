...
use Src\VehicleTicketing\Report\Application\RankingTicketTopByFleetUseCase;
use Src\VehicleTicketing\Report\Infraestructure\Repositories\EloquentTicketReportRepository;

final class RankingTopTicketByClientController
{
    private $repository;
    ...
    public function __invoke( Request $request ): array
    {
        ...
        $useCase = new RankingTicketTopByFleetUseCase($this->repository);
