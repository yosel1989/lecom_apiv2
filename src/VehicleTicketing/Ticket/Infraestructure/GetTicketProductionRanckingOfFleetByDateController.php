...
final class GetTicketProductionRanckingOfFleetByDateController
{
    ...
    public function __invoke( Request $request ) : array
    {
        ...
        $getTicketProductionRanckingOfFleetByDateUseCase = new GetTicketProductionRanckingOfFleetByDateUseCase($this->repository);
        return $getTicketProductionRanckingOfFleetByDateUseCase->__invoke($start,$end,$arrIdVehicle);
